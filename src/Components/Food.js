...
function Food() {
  ...
  useEffect(() => {
    document.body.style.backgroundColor='rgb(240, 169, 230)';
    ...
    <>
      ...
      <div className='container'>
        ...
        <div className="containercontent">
          ...
          <div className='image-container'><img src="https://restaurantindia.s3.ap-south-1.amazonaws.com/s3fs-public/content6054.jpg" className="bolimg" alt="purple scene" /></div>
          </Link>
...
" className="bolimg" alt="purple scene" /></div>
          ...
          <div className='image-container'><img src="https://t0.gstatic.com/licensed-image?q=tbn:ANd9GcQSFqbWlV7IqvASUvK-OTW9ljoDeJa1lCkSKYSXH7YY1SAQ-y1ZIYIYCUcPyHsYsRaBO5SoNZNmxAMTWmo" className="bolimg" alt="purple scene" /></div>
          </Link>
          <div className='pcontent'>
