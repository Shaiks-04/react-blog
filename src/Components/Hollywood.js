                ...
                <div className="containercontent">
                    <div className="contentcard">
                        <Link to='/Hollywood/Hollyone'>
                            <div className='image-container'><img src="https://m.media-amazon.com/images/M/MV5BMmZiN2VmMjktZDE5OC00ZWRmLWFlMmEtYWViMTY4NjM3ZmNkXkEyXkFqcGdeQXVyMTI2MTc2ODM3._V1_FMjpg_UX1000_.jpg" id="imgm" className="bolimg" alt="purple scene" /></div>
                        </Link>
                    ...
                    <div className="contentcard">
                        <Link to='/Hollywood/Hollytwo'>
                            <div className='image-container'><img src="https://m.media-amazon.com/images/M/MV5BODBjM2M4YTQtNmJlMS00MGU2LWI4ZGYtZTA1MzdmZDAyMjFkXkEyXkFqcGdeQXVyODE5NzE3OTE@._V1_.jpg" id="imgm" className="bolimg" alt="purple scene" /></div>
                        </Link>
                        <div className='pcontent'>
                    ...
                    <div className="contentcard">
                        <Link to='/Hollywood/Hollythree'>
                            <div className='image-container'><img src="https://m.media-amazon.com/images/M/MV5BYWRmNmUxZjItNzJjZS00ZGI1LWFkNmMtMzEzM2NhZmMxMzVlXkEyXkFqcGdeQXVyMTIxNzk0MTY@._V1_.jpg" id="imgm" className="bolimg" alt="purple scene" /></div>
                        </Link>
                        <div className='pcontent'>
                    ...
                    <div className="conctnts">
                        <div className="conctnt">
                            ...
                            <div className='pcontent1'>
                                ...
                                <p className='p2' id='p2'>{a.desccardbear}</p>
                            </div>
                        </div>
                        ...
                        <div className="conctnt">
                            ...
                            <div className='pcontent1'>
                                ...
                                <p className='p2' id='p2'>{a.desccardinsidious}</p>
                            </div>
                        </div>
                        <hr className='mainhr22' />
                        ...
                        <div className="conctnt">
                            ...
                            <div className='pcontent1'>
                                ...
                                <p className='p2' id='p2'>{a.desccardmarvel}</p>
                            </div>
                        </div>
                    </div>
