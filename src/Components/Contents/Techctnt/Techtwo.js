    ...
    return (
        <>
            ...
            <div className='container'>
                ...
                <div className='image-container'><img src="https://media.nationthailand.com/uploads/images/md/2023/02/LnHGoajYyVef4oiO3bbg.webp?x-image-process=style/lg" id="imgr" className="bolimg" alt="purple scene" /></div>
