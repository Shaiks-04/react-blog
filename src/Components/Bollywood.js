                ...
                <div className="containercontent">
                    <div className="contentcard">
                        ...
                        <Link to='/bollywood/Bollyone'>
                            <div className='image-container'><img src="https://images.livemint.com/img/2023/03/21/600x338/The-film-has-been-produced-by-Tips-Films-and-Music_1679375273338.png" className="bolimg" id="imgm" alt="purple scene" /></div>
                        </Link>
                    ...
                    <div className="contentcard">
                        ...
                        <Link to='/bollywood/Bollytwo'>
                            <div className='image-container'><img src="https://akamaividz2.zee5.com/image/upload/w_856,h_482,c_scale,f_webp,q_auto:eco/resources/0-0-1z5326731/list/1170x65663742f5472f42b1a505a4642818bd6a.jpg" className="bolimg" id="imgm" alt="purple scene" /></div>
                        </Link>
                    ...
                    <div className="contentcard">
                        <Link to='/bollywood/Bollythree'>
                            <div className='image-container'><img src="https://m.media-amazon.com/images/M/MV5BYjBkMGE5ZjEtOTdkNC00OTA5LWIzOWQtMmJmODRlMmRhM2YxXkEyXkFqcGdeQXVyMTI1NDEyNTM5._V1_.jpg" className="bolimg" id="imgm" alt="purple scene" /></div>
                        </Link>
                        <div className='pcontent'>
                    ...
                    <div className="conctnts">
                        <div className="conctnt">
                            ...
                            <div className='pcontent1'>
                                ...
                                <p className='p2' id='p2'>{a.desccardom}</p>
                            </div>
                        </div>
                        ...
                        <div className="conctnt">
                            ...
                            <div className='pcontent1'>
                                ...
                                <p className='p2' id='p2'>{a.desccardbhola}</p>
                            </div>
                        </div>
                        <hr className='mainhr1' />
                        <div className="conctnt">
                            ...
                            <div className='pcontent1'>
                                ...
                                <p className='p2' id='p2'>{a.desccardyodha}</p>
                            </div>
                        </div>
                    </div>
