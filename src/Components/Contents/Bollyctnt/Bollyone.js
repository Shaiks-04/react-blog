    ...
    return (
        <>
            ...
            <div className='container'>
                ...
                <div className='image-container'><img src="https://images.livemint.com/img/2023/03/21/600x338/The-film-has-been-produced-by-Tips-Films-and-Music_1679375273338.png" className="bolimg" id="imgr" alt="purple scene" /></div>
                <p></p>
            </div>
